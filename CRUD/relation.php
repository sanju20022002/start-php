   ...
   <div class="main-container">
        <!-- Form Section Start -->
            <form action="createpost.php" method="post">
                <h2 class="reg-heading"> RELATION</h2>
                ...
                <div class="input-row">
                    ...
                    <div class="input-box">    
                        <label for="fname" class="reg-label">Father's Name</label>
                        <input type="text"  class="reg-input"  name="fname">
                    </div>
                    <div class="input-box"> 
                        <label for="address" class="reg-label">Address:</label>
                        <textarea name="address" id=""></textarea>
</div> 
                    <div class="input-box">    
                        <label for="mname" class="reg-label">Mother's Name</label>
