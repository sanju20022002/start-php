...
?>
                <tr>
                   ...
                   <td><?=$record['phone']?></td>
                   <td><?=$record['email']?></td>
                   <td><a  class="admin-batch-bLink" href="delete.php?id=<?=$record['id']?>"><i class="fa fa-file"></i>delete</a></td>

                   <td><a  class="admin-batch-bLink" href="update.php?id=<?=$record['id']?>"><i class="fa fa-file"></i>edit</a></td>
                </tr>
<?php    
    }
}
