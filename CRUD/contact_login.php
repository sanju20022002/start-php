...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $sql="Select * from contact_signup where email='$email' and password='$password'";
    ...
    // if($email=='a@gmail.com' && $password=='123'){
        ...
        echo "<script>
        alert ('Email or confirm password not matched');
        </script>";
    }
    }
?>
   ...
   <div class="main-container">
        <!-- Form Section Start -->
            <form action="" method="post">
                <h2 class="reg-heading"> Contact_login</h2>
                    ...
                    <div class="input-box">    
                        <label for="password" class="reg-label">Pasword :</label>
